      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex flex-col gap-4 mb-6 lg:gap-4 lg:mb-12 lg:flex-row">
          {formatSelectionData.map((format, index) => (
            <div
              key={index}
              className="bg-back rounded-md px-8 py-8 mx-16 lg:py-12 lg:mx-0"
            >
              <h3 className="text-2xl uppercase pb-2 lg:text-3xl">
                {' '}
                {format.title}{' '}
              </h3>
              <h4 className="uppercase text-accent text-xs pb-4">
                {' '}
                {format.subtitle}{' '}
              </h4>
