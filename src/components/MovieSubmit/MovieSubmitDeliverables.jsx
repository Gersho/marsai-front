    ...
    <div className="border-zinc-600 rounded-md w-11/12 flex flex-col items-center pb-4 gap-6 bg-zinc-800 text-zinc-200">
      ...
      <div className="w-5/6 flex flex-col justify-center sm:flex-row sm:justify-evenly gap-6">
        <div className="flex flex-col justify-center items-center gap-3 w-full">
          ...
          <InputImage className="aspect-video w-full max-w-sm" label="Vignette Officielle (16:9) *" id="poster" name="poster" iconSize={80} description="Cliquez pour upload" subDescription="PNG ou JPG • Max 15Mo" register={register} />
        </div>
        <div className="flex flex-col items-center gap-3 w-full">
          <p>Galerie Médias (Stills - Max 3)</p>
          <div className="flex justify-center items-center gap-3">
            <InputImage className="aspect-3/4 w-20 justify-center" label="Galerie Médias premiere image" id="still-image-a" name="still-image-a" register={register} />
            <InputImage className="aspect-3/4 w-20 justify-center" label="Galerie Médias deuxieme image" id="still-image-b" name="still-image-b" register={register} />
            <InputImage className="aspect-3/4 w-20 justify-center" label="Galerie Médias troisieme image" id="still-image-c" name="still-image-c" register={register} />
          </div>
        </div>
      </div>
    </div>
