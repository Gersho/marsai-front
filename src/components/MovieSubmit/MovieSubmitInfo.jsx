        ...
        <div className="w-11/12 flex flex-col items-center gap-3">
            ...
            <div className="flex flex-col items-center w-full sm:flex-row sm:w-5/6 sm:justify-around">
                ...
                <div className="flex flex-col w-5/6 sm:w-3/7">
                    ...
                    <textarea className="border border-gray rounded-sm p-3 my-2 h-36 sm:h-44" id="form-movie-synopsis" type="textarea" name="original-synopsis" placeholder="résumez l’intention de votre film et l’histoire qu’il raconte en quelques lignes..." title="synopsis langue originale (max. 300 caractères)"
                        required></textarea>
                </div>
                ...
                <div className="flex flex-col w-5/6 sm:w-3/7">
                    <div className="flex justify-between">
                        <label htmlFor="form-movie-synopsis-english">synopsis anglais *</label>
                        <p>0/300</p>
                    </div>
                    <textarea className="border border-gray rounded-sm p-3 my-2 h-36 sm:h-44" id="form-movie-synopsis-english" type="textarea" name="english-synopsis" placeholder="résumez l’intention de votre film et l’histoire qu’il raconte en quelques lignes..." title="synopsis anglais* (max. 300 caractères)"
                        required></textarea>
                </div>
