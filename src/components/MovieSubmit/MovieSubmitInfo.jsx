  ...
  return (
    ...
    <div className="w-11/12 flex flex-col items-center gap-3">
      ...
      <div className="flex flex-col w-5/6 sm:flex-row sm:justify-around gap-3">
        ...
        <div className="flex flex-col  sm:flex sm:flex-col  sm:w-3/7">
          <label htmlFor="form-english-translation">
            Traduction anglaise *
          </label>
          <input
            className="border border-gray rounded-sm pl-2 py-1 my-2"
      ...
      <div className="flex flex-col w-5/6 sm:flex-row sm:justify-around">
        <div className="flex flex-col  sm:flex sm:flex-col sm:w-3/7">
          <label htmlFor="form-movie-duration">
            Dureé exacte * (en secondes)
          </label>
          <input
            className="border border-gray rounded-sm pl-2 py-1 my-2"
        ...
        <div className="flex flex-col  sm:flex sm:flex-col sm:w-3/7">
          <label htmlFor="form-main-language">
