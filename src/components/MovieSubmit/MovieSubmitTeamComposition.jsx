function MovieSubmitTeamComposition() {
    return (
        <div className="w-11/12 flex flex-col items-center gap-3">
            <h2 className="px-4 py-2 self-start sm:self-center">04. Composition de l&apos;Équipe</h2>
            ...
            <div className="flex flex-col w-5/6 sm:flex-row sm:justify-around gap-3">
                ...
                <div className="flex flex-col">
                    ...
                    <select className="w-fit py-1" name="form-collaborator-gender" id="collaborator-gender">
                        <option value="mr">Mr.</option>
                        <option value="mme">Mme.</option>
                        <option value="mx">Mx.</option>
                    </select>
                ...
                <div className="flex flex-col sm:w-full">
                    ...
                    <input className="border border-gray rounded-sm  pl-2 py-1 my-2" id="form-collaborator-firstname" type="text" name="collaborator-firstname" placeholder="Prenom" title="Prenom du collaborateur"
                        required></input>
                </div>

                <div className="flex flex-col sm:w-full">
                    <label htmlFor="form-collaborator-lastname">Nom *</label>
                    <input className="border border-gray rounded-sm  pl-2 py-1 my-2" id="form-collaborator-lastname" type="text" name="collaborator-lastname" placeholder="Nom" title="Nom du collaborateur"
                        required></input>
                </div>
