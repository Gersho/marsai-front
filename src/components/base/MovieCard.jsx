...
function MovieCard({
    ...
    if (language === undefined) {
        language = { lang: "ZZ", text: "Unknown", icon: "❌", textFr: "Inconnu", textEn: "Unknown" };
    }
            ...
            <div className="px-1 ">
                <div className="flex flex-row justify-between ">
                    <div className="flex flex-col  min-w-0 max-w-100">
                        <p className="text-md font-bold truncate" title={data.english_title}>{english_title}</p>
                        <p className="text-sm truncate" title={data.original_title}>{original_title}</p>
                    </div>
                ...
                <div className="flex flex-row justify-between">
                    ...
                    <div className="flex flex-col">
                        <p title={i18n.language === 'fr' ? language.textFr : language.textEn}>{language.icon} </p>
                    </div>
                </div>
