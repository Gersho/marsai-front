...
function AdminPage() {
  ...
  return (
    <div className="pt-17 sm:min-h-screen flex-none sm:flex">
      <div className="mt-3 sm:w-70">
        <nav className="flex sm:flex-col flex-row flex-wrap sm:flex-nowrap sm:mx-2 sm:gap-2 ">
